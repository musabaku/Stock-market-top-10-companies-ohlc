...
ohlc_df.to_excel('annual_ohlc_data_summary.xlsx', index=False)

print("Annual OHLC data for the specified companies has been saved to 'annual_ohlc_data_summary.xlsx'")
